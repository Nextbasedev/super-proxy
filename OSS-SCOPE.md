...
Source baseline: model-gateway `origin/main` @ `787d2dd`  
...
- Production deploy-guard / host-specific runbooks
- Company emails, Firebase project IDs, internal domains, account labels
- Internal dashboard/console UI (`public/`) — deferred to wave 2 as `apps/console`
...
- No private markers: aside, oc-fleet, infinitycorp, Daxitdon, ampere project ids, deploy-guard hosts
